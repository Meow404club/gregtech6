#!/usr/bin/env python3
"""p26-c-foam-block-family — the C-Foam BLOCK family live chain (declarative framework,
the p25_cfoam_spray shape).

Chain semantics (task p26-c-foam-block-family ACCEPTANCE — "喷管面回归不破（P25 链绿）
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p26_cfoam_blocks.py
Dual: python3 tools/rcon/chains/p26_cfoam_blocks.py --node 1.21.1-neoforge
"""
