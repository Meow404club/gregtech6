#!/usr/bin/env python3
"""logistics-lv3 — the Logistics Core live acceptance chain.

The live half of task logistics-lv3. One fresh band z=236..250,
...
Run:  python3 tools/rcon/chains/logistics_core.py
      python3 tools/rcon/chains/logistics_core.py --node 1.21.1-neoforge
"""
