#!/usr/bin/env python3
"""tool_ladder_dig_materials — the dig-family material ladder chain (task dig-ladder,
the dig_six speed-arm shape extended with the <material> identity arms).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/dig_ladder_materials.py
"""
...
CHAIN = Chain(
    name="tool_ladder_dig_materials",
    slug="toolladderdigmaterials",
