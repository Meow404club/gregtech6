#!/usr/bin/env python3
"""scene-six SCOOP chain — the cobweb/vine full-drop arm (the PLANT_SELF_DROP loot seam).

Chain semantics (task scene-six RCON arm 4, the /gt6scene6 mine channel over
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/scene_six_scoop.py
"""
