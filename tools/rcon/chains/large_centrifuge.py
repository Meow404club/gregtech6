#!/usr/bin/env python3
"""large-centrifuge — the Large Centrifuge chain (task large-12, the
large12 sweep group; Loader_MultiTileEntities.java:1229).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/large_centrifuge.py
"""
...
CHAIN = Chain(
    name="large-centrifuge large12",
    slug="largecentrifuge",
