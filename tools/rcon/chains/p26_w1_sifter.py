#!/usr/bin/env python3
"""p26-w1-sifter — the Sifter family (KU) live acceptance chain, the FULL ladder
T1-T4 (the p24_canner_refill shape: place → input → inject → the output-slot
...
Chain semantics (task p26-w1-sifter-compressor-wiremill ACCEPTANCE rcon ① —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p26_w1_sifter.py
"""
