#!/usr/bin/env python3
"""cover-shutter-filter — pilot declarative RCON acceptance chain.

Pilot migration of tmp/rcon-scripts/shutterfilter_atom.sh (the 33/33
...
Run:  python3 tools/rcon/chains/cover_shutter_filter.py
"""
...
CHAIN = Chain(
    name="cover-shutter-filter",
    slug="ssf",                       # the atom-era artifact names, kept
