#!/usr/bin/env python3
"""qu-energizer — the EU->LU->QU chain live acceptance (sweep group
qu_energizer; the qu_laser rig geometry, x-disjoint columns east of it):
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/qu_energizer.py
"""
...
# the massfab small-form inventory merge (live-proven): one iron ingot in slot 0 —
...
CHAIN = Chain(
    name="qu_energizer quantum energizer",
    slug="quenergizer",
