#!/usr/bin/env python3
"""electric-nineteen DRILL chain — the EU drain arm, the empty refusal and
the BatteryBox charge arm (task electric-nineteen, the fresh z=240 band,
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/electric_drill.py
"""
...
CHAIN = Chain(
    # the name carries the band key: sweep --group electric_tools matches this member
    name="electric_tools electric-drill",
    slug="electricdrill",
