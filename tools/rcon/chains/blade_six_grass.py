#!/usr/bin/env python3
"""blade-six GRASS chain — the sword grass/stick/vine harvest live arm.

Chain semantics (task blade-six RCON arm 2, the /gt6blade mine channel —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/blade_six_grass.py
"""
