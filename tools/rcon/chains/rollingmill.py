#!/usr/bin/env python3
"""rollingmill — the RollingMill RU ladder live acceptance chain (task
kinetic-roll-ladder, the wiremill shape + the P28 arm-A real-source rig).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/rollingmill.py
"""
...
# report out[0]=<count>x <item> — the 21.1 leg namespaces the item path (the P26 W1 fork)
