#!/usr/bin/env python3
"""blade-ladder STATS chain — the blade material ladder per-material verdicts.

Chain semantics (task blade-ladder acceptance — the "GT6BladeToolCommand 链逐材质
...
No world sites — the stats arm is a pure command channel (the ore_mech
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/tool_ladder_stats.py
...
CHAIN = Chain(
    name="tool-ladder-stats",
    slug="toolladderstats",
    sites=ANCHOR,
