#!/usr/bin/env python3
"""energy_ld_transformer — the Long Distance transformer + LD electric wire
live acceptance (sweep group energy_ld; the fresh band x563..575, z453..464
...
the covers band z300..312).
  ...
  battery_box_ev + one EMPTY EV battery (the P29 W4 chargeable-carrier form;
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/energy_ld_transformer.py
"""
...
CHAIN = Chain(
    name="energy_ld_transformer long distance transformer + LD wire live",
    slug="eldtrans",
