#!/usr/bin/env python3
"""large-bath — the Large Bathing Vat chain (task large-12, the
large12 sweep group; Loader_MultiTileEntities.java:1233).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/large_bath.py
"""
