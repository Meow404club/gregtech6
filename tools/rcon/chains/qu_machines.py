#!/usr/bin/env python3
"""qu-scanner-replicator — the QU machine pair chain (task qu-scanner-replicator,
the qu_machines sweep group; Loader_MultiTileEntities.java:1551/:1556-1558).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/qu_machines.py
"""
...
# the fresh z=348 band EAST of the qu_usb chest column (x382..398): the two rigs
...
CHAIN = Chain(
    name="qu-scanner-replicator qu_machines",
    slug="qumachines",
