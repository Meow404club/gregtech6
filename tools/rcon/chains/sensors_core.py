#!/usr/bin/env python3
"""sensors-core — the sensor-family live acceptance chain (the food_can shape).

Chain semantics (task sensors-core ACCEPTANCE — "place sensor → 对目标 → read 各
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/sensors_core.py
      python3 tools/rcon/chains/sensors_core.py --node 1.21.1-neoforge
"""
