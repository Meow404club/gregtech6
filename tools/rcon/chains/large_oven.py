#!/usr/bin/env python3
"""large-oven — the Large Electric Oven chain (task large-12, the
large12 sweep group; Loader_MultiTileEntities.java:1236).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/large_oven.py
"""
