#!/usr/bin/env python3
"""p29_w2_cryo_mixer — the Cryo Mixer family (CU, RM.CRYO_MIXER) live acceptance chain,
the FULL 5-tier ladder T1-T5 (task p29-w2-exotic-energy ACCEPTANCE ②/④: the
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w2_cryo_mixer.py
"""
