#!/usr/bin/env python3
"""p29_w2_laser_welder — the Laser Welder family (LU, RM.WELDER) live acceptance chain,
the FULL 5-tier ladder T1-T5 (task p29-w2-exotic-energy).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w2_laser_welder.py
"""
...
CHAIN = Chain(
    name="p29_w2_exotic laser-welder",
    slug="p29w2laserwelder",
