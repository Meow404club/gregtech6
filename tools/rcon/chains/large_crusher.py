#!/usr/bin/env python3
"""large-crusher — the Large Crusher chain (task large-12, the
large12 sweep group; Loader_MultiTileEntities.java:1238).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/large_crusher.py
"""
