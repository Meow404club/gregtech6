#!/usr/bin/env python3
"""p29-w3-large-autoclave — the Large Autoclave chain (task p29-w3-large-12, the
p29_w3_large12 sweep group; Loader_MultiTileEntities.java:1232).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w3_large_autoclave.py
"""
...
CHAIN = Chain(
    name="p29-w3-large-autoclave p29_w3_large12",
    slug="p29w3largeautoclave",
