#!/usr/bin/env python3
"""p13-hu-steam-foundation — the HU energy-face evidence chain (declarative framework).

Chain semantics (task p13-hu-steam-foundation spec ④ — the existing P8 energy rig only,
