#!/usr/bin/env python3
"""large-shredder — the Large Shredder chain (task large-12, the
large12 sweep group; Loader_MultiTileEntities.java:1239).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/large_shredder.py
"""
