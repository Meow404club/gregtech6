#!/usr/bin/env python3
"""eu-bridge (heater leg) — the Electric Heater EU->HU live acceptance chain
(task eu-bridge RCON group eu_bridge; the large_dynamo rig
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/electric_heater.py
"""
...
CHAIN = Chain(
    name="eu_bridge electric heater",
    slug="heater",
