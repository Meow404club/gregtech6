#!/usr/bin/env python3
"""field-five PLOW chain — the 3x3x3 snow-sweep live arm.

Chain semantics (task field-five RCON arm 1, the /gt6field break channel —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/field_five_plow3x3.py
"""
...
CHAIN = Chain(
    name="field-five-plow3x3",
    slug="fieldfiveplow3x3",
