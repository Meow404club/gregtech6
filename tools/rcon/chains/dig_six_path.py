#!/usr/bin/env python3
"""dig-six PATH chain — the Behavior_Place_Path live arm.

Chain semantics (task dig-six RCON arm 2, the /gt6dig use channel — the
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/dig_six_path.py
"""
