#!/usr/bin/env python3
"""pool-prospector — the /gt6tool prospect live acceptance chain (the P29 W5 band
...
Chain semantics (task pool-prospector ACCEPTANCE ③):
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/prospector.py
"""
