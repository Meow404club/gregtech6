#!/usr/bin/env python3
"""p35-rails-detector — the GT6 detector-track chain (task p35-rails-31-blocks, ACCEPTANCE
rail-detector).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p35_rails_detector.py
"""
...
CHAIN = Chain(
    name="p35-rails-detector",
    slug="p35_rails_detector",
