#!/usr/bin/env python3
"""circuits_parts — the circuits-part registration chain (task
circuits-parts RCON: the Ventilation Unit 18299 + the five Quadcore
...
JSON variant parse, the parts form), the DESIGNS-0 rows carry NO design
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/circuits_parts.py
"""
...
# x/z-disjoint from the parts band z=292 (x384..464) with margin.
X0, Z = 384, 284
...
CHAIN = Chain(
    name="circuits_parts circuits-parts",
    slug="circuitsparts",
