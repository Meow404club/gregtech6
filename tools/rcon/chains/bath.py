#!/usr/bin/env python3
"""bath — the TU Bath chain (task hu-tu-piggyback, group hu_tu;
...
duration 128):
  ...
  the kitchen_pot card registered (its static wood-oil ladder pours ZERO rows live
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/bath.py
"""
