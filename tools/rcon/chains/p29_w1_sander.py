#!/usr/bin/env python3
"""p29_w1_sander — the Sanding Machine family (RU, RM.SHARPENING) live acceptance
chain, the FULL ladder T1-T4 (task p29-w1-kinetic-process-ladder).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w1_sander.py
"""
