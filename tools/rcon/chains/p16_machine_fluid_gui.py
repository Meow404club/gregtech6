#!/usr/bin/env python3
"""p16-machine-fluid-gui — the dryer menu-open smoke chain (declarative framework).

Chain semantics (task p16-machine-fluid-gui ACCEPTANCE, "place dryer → 打开 menu 臂"):
...
node segment would cross-fire — the p16-aqua-fluids lesson).

Run:  GT6_SESSION=off python3 tools/rcon/chains/p16_machine_fluid_gui.py
"""
...
# The four dryer sites, x 200-260 — clear of the p13/p14/p16_side_io sites (x 100-160)
...
# driven-ticks x mInputMax arithmetic observed by the p14-dryer-family chain.
TIERS = [
