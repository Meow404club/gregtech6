#!/usr/bin/env python3
"""hot-lube-lube — the Diesel Engine lubricant live acceptance chain (task
hot-lube; the engine-diesel e2e form):
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/hot_lube_lube.py
"""
