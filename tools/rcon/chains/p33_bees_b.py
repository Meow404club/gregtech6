#!/usr/bin/env python3
"""p33_bees_b — the Bumbliary breeding live chain (task p33-bees-lv3-b-bumbliary,
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p33_bees_b.py
"""
...
# the fresh z=368 band — z-disjoint from the p33_bees_a band z=360, the p33_gui_distill
# band z=356 and the p32_qu_usb band z=348.
...
CHAIN = Chain(
    name="p33-bees-lv3-b-bumbliary p33_bees_b",
    slug="p33beesb",
