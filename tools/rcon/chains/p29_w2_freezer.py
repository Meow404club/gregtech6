#!/usr/bin/env python3
"""p29_w2_freezer — the Freezer family (CU, RM.FREEZER) live acceptance chain, the FULL
5-tier ladder T1-T5 (task p29-w2-exotic-energy ACCEPTANCE ④: the CU supply rides the
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w2_freezer.py
"""
