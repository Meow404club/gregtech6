#!/usr/bin/env python3
"""electric-nineteen FACES chain — the per-form mining-surface reads live
(task electric-nineteen, the chain-4 column x640..646; the offline JVM does
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/electric_faces.py
"""
...
CHAIN = Chain(
    name="electric_tools electric-faces",
    slug="electricfaces",
