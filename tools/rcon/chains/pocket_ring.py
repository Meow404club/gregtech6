#!/usr/bin/env python3
"""pocket_ring — the pocket multitool ring chain (task pocket-eight,
the tool_hammer_wrench give-arm shape: RCON sessions have no player, so the headless
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/pocket_ring.py
"""
