#!/usr/bin/env python3
"""distillery — the Distillery family live acceptance chain (declarative framework).

Chain semantics (task distillery-family ACCEPTANCE — "RCON place 四变体+circuit
...
Run:  python3 tools/rcon/chains/distillery.py   (GT6_SESSION=off for the
