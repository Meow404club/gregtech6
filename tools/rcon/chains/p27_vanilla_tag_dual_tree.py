...
PLATFORM injection half, which is the correct structure, not a defect):
  ...
  B the forward twin faces, merged on both legs: on the FORGE leg c:ingots/iron
    ...
    p28-neotag-graft, commit 9f119234 — the neoforgeTagFaces Copy task mirrors
    ...
    re-ruling — docs/adr/2026-09-05-p17-datagen-tree.md §6, task
    p28-neo-tag-wiring): c:ingots/iron answers 2 members [gt6:ingot_iron,
...
# (p28-neotag-graft 9f119234, the neoforgeTagFaces Copy task in
...
# live-measured post-graft (both passes, /tmp/p28wt_rcon_neo_red.log):
