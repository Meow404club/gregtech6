#!/usr/bin/env python3
"""p32-qu-laser-domain — the EU->LU->EU laser chain live acceptance (sweep group
p32_qu_laser; the p29_w4_electric_heater rig geometry, one column per arm):
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p32_qu_laser.py
"""
