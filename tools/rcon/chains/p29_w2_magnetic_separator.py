#!/usr/bin/env python3
"""p29_w2_magnetic_separator — the Magnetic Separator family (MU, RM.MAGNETIC_SEPARATOR)
live acceptance chain, the FULL 5-tier ladder T1-T5 (task p29-w2-exotic-energy).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w2_magnetic_separator.py
"""
...
CHAIN = Chain(
    name="p29_w2_exotic magnetic-separator",
    slug="p29w2magneticseparator",
