#!/usr/bin/env python3
"""p29-w5-t6-electric-nineteen JACKHAMMER chain — the rockGt conversion and the no-ores
zero-break arm (task p29-w5-t6-electric-nineteen, the chain-3 column x630..638):
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w5_t6_electric_jackhammer.py
"""
...
CHAIN = Chain(
    name="p29-w5-t6-electric-jackhammer p29_w5_t6_electric",
    slug="p29w5t6electricjackhammer",
