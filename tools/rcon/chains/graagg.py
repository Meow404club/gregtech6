#!/usr/bin/env python3
"""graagg — the Von da Graagg spawn-suppression tower chain (task graagg,
the graagg sweep group; Loader_MultiTileEntities.java:1280).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/graagg.py
"""
