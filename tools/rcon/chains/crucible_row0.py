#!/usr/bin/env python3
"""crucible-row0 — the crucible-chain live acceptance (task crucible-physics-smeltery,
...
Run:  python3 tools/rcon/chains/crucible_row0.py
"""
...
CHAIN = Chain(
    ...
    preferred_ports=(26130, 26140),      # this card's pinned rcon/query pair (after foodcan 26110/26120)
    steps=steps,
)
