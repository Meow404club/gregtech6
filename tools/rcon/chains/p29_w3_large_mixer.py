#!/usr/bin/env python3
"""p29-w3-large-mixer — the Large Batch Mixer chain (task p29-w3-large-12, the
p29_w3_large12 sweep group; Loader_MultiTileEntities.java:1234).
  ...
  2 dust_sand + dust_small_clay + water 1000 -> cfoam, eUt 16, dur 128 — the p29_w1
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w3_large_mixer.py
"""
...
CHAIN = Chain(
    name="p29-w3-large-mixer p29_w3_large12",
    slug="p29w3largemixer",
