#!/usr/bin/env python3
"""nether-lens-end-yield — the nether worldgen live chain (the strata_lens shape).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/nether.py
"""
