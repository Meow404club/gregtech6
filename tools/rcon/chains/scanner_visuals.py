#!/usr/bin/env python3
"""eu-core scanner_visuals — the Scanner (Visuals) family chain (task
eu-core-5tier ACCEPTANCE ①⑤): the EU 5-tier ladder (:1457-1461, no
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/scanner_visuals.py
"""
...
CHAIN = Chain(
    name="eu_core scanner_visuals",
    slug="eucore_scanner_visuals",
