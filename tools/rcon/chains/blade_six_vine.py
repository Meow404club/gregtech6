#!/usr/bin/env python3
"""blade-six VINE chain — the sword vine harvest live arm.

Chain semantics (task blade-six RCON arm 4, the /gt6blade mine channel):
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/blade_six_vine.py
"""
