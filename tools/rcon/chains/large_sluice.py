#!/usr/bin/env python3
"""large-sluice — the Large Sluice chain (task large-12, the
large12 sweep group; Loader_MultiTileEntities.java:1237).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/large_sluice.py
"""
