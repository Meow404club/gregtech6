#!/usr/bin/env python3
"""field-five BRANCH_CUTTER chain — the oak-leaf-to-sapling live arm.

Chain semantics (task field-five RCON arm 3, the /gt6field break channel —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/field_five_leaf2sapling.py
"""
...
CHAIN = Chain(
    name="field-five-leaf2sapling",
    slug="fieldfiveleaf2sapling",
