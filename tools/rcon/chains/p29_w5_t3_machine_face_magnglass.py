#!/usr/bin/env python3
"""p29-w5-t3 machine face — the magnifying-glass zero-change arm (task
p29-w5-t3-machine-face-four ACCEPTANCE ③, the softhammer-chain sibling; the
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w5_t3_machine_face_magnglass.py
"""
...
CHAIN = Chain(
    name="p29-w5-t3-machine-face-magnglass",
    slug="p29w5t3magnglass",
