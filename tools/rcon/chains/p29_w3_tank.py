#!/usr/bin/env python3
"""p29-w3-tank-valves — the Tank Main Valve chain (task p29-w3-tank-valves RCON).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w3_tank.py
"""
