#!/usr/bin/env python3
"""loom — the kinetic Loom chain (task hu-tu-piggyback, group
hu_tu; the RU 4-ladder :1412-1415, the SAME-MAP cross-proof with the W1
ElectricLoom — both carriers ride the ONE GT6RecipeMaps.LOOM instance and the ONE
loom.json smoke row the electricloom chain drives on the EU side):

  arm A — the REAL RU SOURCE (the gt6rcon diesel->axle fixture, the rollingmill
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/loom.py
"""
