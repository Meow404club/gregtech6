#!/usr/bin/env python3
"""fluid-item-carrier — the item-carrier acceptance chain (task fluid-item-carrier).
...
Run:  python3 tools/rcon/chains/fluid-item-carrier.py
"""
