#!/usr/bin/env python3
"""engine-crank — the Hand Crank RU-source acceptance chain (declarative framework).

Chain semantics (task engine-crank acceptance b):
...
Run:  python3 tools/rcon/chains/engine-crank.py
"""
