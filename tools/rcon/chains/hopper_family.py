#!/usr/bin/env python3
"""hopper-family — the storage-hopper family live acceptance chain.

The live half of task storage-hopper-family: the seven-column walk over the
...
Run:  python3 tools/rcon/chains/hopper_family.py
      python3 tools/rcon/chains/hopper_family.py --node 1.21.1-neoforge
"""
...
CHAIN = Chain(
    ...
    steps=[
        ...
        # renamed — the lowercase `item` probe summoned Air, live /tmp/h_rcon_neo2.log)
        # — the fic key-shape ruling: swap ONLY the key shape, the judged
