#!/usr/bin/env python3
"""turbine-dynamo (gas leg) — the Gas Turbine chain (task
turbine-dynamo RCON group turbine_dynamo, the FM.Gas 行跑通 +
...
Two columns of the fresh z=300 band:
  ...
  A the FUEL arm: the gas_turbine_magnalium forms over its 35 dense walls; the
    ...
    fluid-item-carrier key-shape ruling); the FM.Gas row (the datapack
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/gas_turbine.py
"""
...
CHAIN = Chain(
    name="turbine_dynamo gas turbine",
    slug="gasturbine",
