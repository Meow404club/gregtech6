#!/usr/bin/env python3
"""turbine-dynamo (dynamo leg) — the Large Dynamo chain (task
turbine-dynamo RCON group turbine_dynamo).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/large_dynamo.py
"""
...
CHAIN = Chain(
    name="turbine_dynamo large dynamo",
    slug="largedynamo",
