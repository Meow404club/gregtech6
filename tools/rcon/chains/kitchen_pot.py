#!/usr/bin/env python3
"""kitchen-pot-bowl — the manual kitchen family e2e (declarative framework, the
cfoam_refill shape).

Chain semantics (task kitchen-pot-bowl ACCEPTANCE rcon — "place pot→inject 流体+
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/kitchen_pot.py
"""
...
# the 420 band of the 64 layer — clear of cfoamrefill's 412-418 band
...
CHAIN = Chain(
    ...
    preferred_ports=(26131, 26141),      # this card's pinned rcon/query pair (the 2613x segment, after cfoamrefill 26111/26121)
    steps=steps,
)
