#!/usr/bin/env python3
"""scene-six TRIPWIRE chain — the silent-disarm arm (Behavior_TripwireCutting :123).

Chain semantics (task scene-six RCON arm 3, the /gt6scene6 mine channel — the
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/scene_six_tripwire.py
"""
...
CHAIN = Chain(
    name="scene-six-tripwire",
    slug="scenesixtripwire",
