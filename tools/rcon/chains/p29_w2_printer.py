#!/usr/bin/env python3
"""p29-w2-eu-core printer — the Printer family chain (task p29-w2-eu-core-5tier
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w2_printer.py
"""
...
steps = [
    ...
    phase("B: the T1 smoke-row run — paper + water 1000 -> paper (the ink leg rides the UP face)"),
...
CHAIN = Chain(
    name="p29_w2_eu_core printer",
    slug="p29w2eucore_printer",
