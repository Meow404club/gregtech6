#!/usr/bin/env python3
"""blade-six FACES chain — the six blade tools' mining/drop faces live.

Chain semantics (task blade-six RCON arm 5, the /gt6blade mine channel —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/blade_six_faces.py
"""
