...
p32_magic_absorber; the p32_qu_laser rig geometry, two columns):
  ...
  B THE TU LEG (acceptance ②): the coagulator (water 1000 -> 1 snowball,
    eUt 1, the p29_w2_coagulator smoke row) is the TU sink — the skull (the
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p32_magic_absorber.py
"""
...
CHAIN = Chain(
    name="p32_magic_absorber magic field absorber",
    slug="p32magicabsorber",
