#!/usr/bin/env python3
"""p29-w5-t5-scene-six IGNITE chain — the flint-and-tinder chance-strike arm.

Chain semantics (task p29-w5-t5-scene-six RCON arm 1, the /gt6scene6 ignite channel —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w5_t5_scene_six_ignite.py
"""
...
CHAIN = Chain(
    name="p29-w5-t5-scene-six-ignite",
    slug="p29w5t5scenesixignite",
