#!/usr/bin/env python3
"""p29-w5-t5-scene-six SHEEP chain — the scissors shear arm (Behavior_Shears :122).

Chain semantics (task p29-w5-t5-scene-six RCON arm 2, the /gt6scene6 shear channel —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w5_t5_scene_six_sheep.py
"""
...
CHAIN = Chain(
    name="p29-w5-t5-scene-six-sheep",
    slug="p29w5t5scenesixsheep",
