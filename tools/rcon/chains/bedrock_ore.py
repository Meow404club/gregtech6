#!/usr/bin/env python3
"""bedrock-ore — the bedrock-ore live chain (the strata_lens chain shape).
...
The chain therefore pins the faces that hold at EVERY seed:
  ...
  B the /place gate face: a pristine arena (a bedrock floor at y=-64 + a deepslate body,
    ...
    judgment applies, the t2 single-flake precedent). The place is repeated after
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/bedrock_ore.py
"""
