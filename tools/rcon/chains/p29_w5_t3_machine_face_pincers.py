#!/usr/bin/env python3
"""p29-w5-t3 machine face — the pincers dragon-egg arm (task
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w5_t3_machine_face_pincers.py
"""
...
CHAIN = Chain(
    name="p29-w5-t3-machine-face-pincers",
    slug="p29w5t3pincers",
