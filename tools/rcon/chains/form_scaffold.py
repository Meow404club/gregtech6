#!/usr/bin/env python3
"""form-scaffold — the SET scaffold acceptance chain (/gt6multiblock form).

Chain semantics (task form-scaffold ACCEPTANCE):
  ...
  E the /gt6multiblock check-arm regression over the same scene (the check
    report the pattern-checker chain pinned, asserted once here too).

Run:  GT6_SESSION=off python3 tools/rcon/chains/form_scaffold.py
"""
