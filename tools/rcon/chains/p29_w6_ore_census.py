#!/usr/bin/env python3
"""p29_w6_ore_census — the p30 ore wave close-out card's live census chain (task
p30-ore-5-census; the ore registration card 1 fresh_boot form + the p29_w6_rocks_sticks
destroy-drop form).
...
Run:  python3 tools/rcon/chains/p29_w6_ore_census.py [--node 1.21.1-neoforge]
"""
...
CHAIN = Chain(
    name="p29-w6-ore-census",
    slug="p29_w6_ore_census",
