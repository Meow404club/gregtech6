#!/usr/bin/env python3
"""long-distance-pipes — the fluid pipeline live acceptance (sweep group
pipes_ld; the fresh z=502..506 band, x559..642 — the item chain's band
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/pipes_ld_fluid.py
"""
...
# (the canner_refill key-shape fork)
HOT_MERGE = {
...
CHAIN = Chain(
    name="pipes_ld ld-pipe-fluid cross-chunk fluid delegation",
    slug="pipesldfluid",
