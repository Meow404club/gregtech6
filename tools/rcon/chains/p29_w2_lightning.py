#!/usr/bin/env python3
"""p29-w2-eu-special/lightning — the Lightning Processor chain (task p29-w2-eu-special
...
MULTIBLOCK (18104, ported, task p24-lightning-rod); the Lightning Processor is a PLAIN
...
(the p28_fe_inbound wiremill_ulv form, documented on p29_w2_autocrafter.py).

passes=2 is the idempotency proof (the [0,0] of this chain).
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w2_lightning.py
"""
...
CHAIN = Chain(
    name="p29_w2_eu_special lightning",
    slug="p29w2lightning",
