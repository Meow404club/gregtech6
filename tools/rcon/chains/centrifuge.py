#!/usr/bin/env python3
"""centrifuge — the Centrifuge family (RU, RM.CENTRIFUGE) live acceptance chain,
the FULL ladder T1-T4 (task kinetic-process-ladder ACCEPTANCE ③: 并行 1/2/4/8
...
Rig split (the card RCON ruling):
  ...
  T2-T4 — the gt6machine inject rig (the wiremill form; RU delivers on every
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/centrifuge.py
"""
...
# six sides (GTEnergySourceBlockEntity :60) — the gearbox-transformer chain form.
RIG = AXLE1
