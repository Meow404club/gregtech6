#!/usr/bin/env python3
"""dig-six OPENABLE chain — the universal-spade openableCrowbar Unboxinator
walk live arm.

Chain semantics (task dig-six RCON arm 6, the /gt6dig mine channel — the GLM
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/dig_six_openable.py
"""
