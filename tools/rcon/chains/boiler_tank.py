#!/usr/bin/env python3
"""boiler-tank — the Steam Boiler Tank acceptance chain (declarative framework).

Chain semantics (task boiler-tank ACCEPTANCE ②):
...
Run:  python3 tools/rcon/chains/boiler_tank.py
"""
