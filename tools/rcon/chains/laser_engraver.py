#!/usr/bin/env python3
"""laser_engraver — the Laser Engraver family (LU, RM.LASER_ENGRAVER) live
acceptance chain, the FULL 5-tier ladder T1-T5 (task exotic-energy ACCEPTANCE ①:
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/laser_engraver.py
"""
