#!/usr/bin/env python3
"""p12-axle-family — the Axle RU-carrier acceptance chain (declarative framework).

Chain semantics (task p12-axle-family acceptance b):
...
Run:  python3 tools/rcon/chains/p12-axle-family.py
"""
