#!/usr/bin/env python3
"""armor-recipe — the universal-assembly craft surrogate arm (task
armor-24). RCON has no player and vanilla exposes no crafting command (the
tool-hammer-wrench precedent), so the "craft 一套 universal" face is the committed
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/armor_recipe.py
"""
