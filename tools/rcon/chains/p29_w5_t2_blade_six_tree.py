#!/usr/bin/env python3
"""p29-w5-t2-blade-six TREE chain — the axe whole-tree felling live arm.

Chain semantics (task p29-w5-t2-blade-six RCON arm 1, the /gt6blade chop channel —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w5_t2_blade_six_tree.py
"""
...
CHAIN = Chain(
    name="p29-w5-t2-blade-six-tree",
    slug="p29w5t2bladesixtree",
