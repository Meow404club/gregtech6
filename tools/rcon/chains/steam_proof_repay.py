#!/usr/bin/env python3
"""steam-proof-repay — the steam-proof deviation repayment acceptance chain.

Closes the 2026-09-02-steam-proof-deviation window: pre-card a gas-proof drum
...
Run:  python3 tools/rcon/chains/steam_proof_repay.py
"""
