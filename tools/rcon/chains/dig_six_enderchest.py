#!/usr/bin/env python3
"""dig-six ENDER CHEST chain — the construction-pick drop conversion live arm.

Chain semantics (task dig-six RCON arm 3, the /gt6dig mine channel — the
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/dig_six_enderchest.py
"""
...
CHAIN = Chain(
    name="dig-six-enderchest",
    slug="digsixenderchest",
