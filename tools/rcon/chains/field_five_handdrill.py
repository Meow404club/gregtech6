#!/usr/bin/env python3
"""field-five HAND_DRILL chain — the declared-empty negative arm.

Chain semantics (task field-five RCON arm 4, the /gt6field speed channel —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/field_five_handdrill.py
"""
...
CHAIN = Chain(
    name="field-five-handdrill",
    slug="fieldfivehanddrill",
