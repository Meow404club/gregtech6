#!/usr/bin/env python3
"""rm-row-backfill — the SHREDDER/LATHE backfill round-trip chain (declarative framework).

Chain semantics (task rm-row-backfill ACCEPTANCE): three new-row round-trips through
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/rm_backfill.py [--node 1.21.1-neoforge]
"""
...
# one above (dy=2 covers it), the drying_rows feed idiom.
