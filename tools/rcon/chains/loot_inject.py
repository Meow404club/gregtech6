#!/usr/bin/env python3
"""loot-injection — the dungeon-loot injection live acceptance chain.
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/loot_inject.py
      python3 tools/rcon/chains/loot_inject.py --node 1.21.1-neoforge
"""
