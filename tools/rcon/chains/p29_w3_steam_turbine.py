#!/usr/bin/env python3
"""p29-w3-turbine-dynamo (steam leg) — the Steam Turbine chain (task
p29-w3-turbine-dynamo RCON group p29_w3_turbine_dynamo, the STEAM 夹具 leg).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w3_steam_turbine.py
"""
...
CHAIN = Chain(
    name="p29_w3_turbine_dynamo steam turbine",
    slug="p29w3steamturbine",
