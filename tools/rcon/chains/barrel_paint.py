#!/usr/bin/env python3
"""barrel-paint-render — the barrel paint consumer-face live acceptance chain.

Chain semantics (task barrel-paint-render ACCEPTANCE ④): the /gt6machine paint
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/barrel_paint.py
"""
