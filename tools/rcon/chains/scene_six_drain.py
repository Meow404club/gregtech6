#!/usr/bin/env python3
"""scene-six DRAIN chain — the plunger 1000 L void-drain arm (Behavior_Plunger_Fluid :48-62).

Chain semantics (task scene-six RCON arm 5, the /gt6scene6 use channel over
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/scene_six_drain.py
"""
