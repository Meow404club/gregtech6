#!/usr/bin/env python3
"""battery-storage (charge leg) — the BatteryBox CHARGE chain (task
battery-storage, RCON group battery; the fresh z=336 band, the
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/battery_charge.py
"""
