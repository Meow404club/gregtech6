#!/usr/bin/env python3
"""p16-aqua-fluids — the six aqua fluids live chain (declarative framework).

Chain semantics (task p16-aqua-fluids ACCEPTANCE — "RCON /gt6tank fill 逐新流体臂
...
Run:  python3 tools/rcon/chains/p16_aqua_fluids.py
"""
