#!/usr/bin/env python3
"""p29-w4-eu-bridge (roasting leg) — the Roasting Oven 4-ladder live acceptance chain
(task p29-w4-eu-bridge; the p29_w3_smelter chain shape — the /gt6machine arms over
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w4_roasting_oven.py
"""
...
CHAIN = Chain(
    name="p29_w4_eu_bridge roasting oven",
    slug="p29w4roasting",
