#!/usr/bin/env python3
"""hot-lube-hex — the HEX hot-coolant live acceptance chain (task
hot-lube; the heat-exchanger boiler-stack form):
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/hot_lube_hex.py
"""
...
steps = [
    ...
    # keepFilter read-side rebuild, landing fuel=0/163840 — the hl neo runs)
