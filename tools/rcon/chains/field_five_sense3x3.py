#!/usr/bin/env python3
"""field-five SENSE chain — the 3x3 grass-carpet live arm.

Chain semantics (task field-five RCON arm 2, the /gt6field break channel —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/field_five_sense3x3.py
"""
...
CHAIN = Chain(
    name="field-five-sense3x3",
    slug="fieldfivesense3x3",
