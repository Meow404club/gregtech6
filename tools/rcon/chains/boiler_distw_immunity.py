#!/usr/bin/env python3
"""boiler-distw-immunity — the distilled-water immunity live chain (declarative framework).

Chain semantics (task boiler-distw-immunity ACCEPTANCE — the :119 criterion is
...
Run:  python3 tools/rcon/chains/boiler_distw_immunity.py
"""
