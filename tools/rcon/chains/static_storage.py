#!/usr/bin/env python3
"""storage-static-batch — the static storage batch live acceptance chain.

The live half of task storage-static-batch: the five no-tick storage containers
...
Run:  python3 tools/rcon/chains/static_storage.py
      python3 tools/rcon/chains/static_storage.py --node 1.21.1-neoforge
"""
