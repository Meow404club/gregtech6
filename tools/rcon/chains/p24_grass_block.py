#!/usr/bin/env python3
"""p24-grass-block — the GT grass family live acceptance chain (the p23 barrel chain shape).

Chain semantics (task p24-grass-block RCON arm): the spray-can GRASS route is LIVE —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p24_grass_block.py
"""
...
CHAIN = Chain(
    name="p24-grass-block",
    slug="p24grassblock",
    sites=gt6world.declare_sites(V, G, X),
    preferred_ports=(26107, 26117),      # this card's pinned rcon/query pair (the 2610x segment, after p24dyechemical 26106/26116)
    steps=steps,
)
