#!/usr/bin/env python3
"""p30-w6-t1-trees-nine — the 9-tree worldgen live acceptance chain (the p24 grass chain shape).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w6_t1_trees.py
"""
...
CHAIN = Chain(
    name="p29-w6-t1-trees",
    slug="p29_w6_t1_trees",
    sites=gt6world.declare_sites(PLATFORM, TREES),
    preferred_ports=(26108, 26118),      # this card's pinned rcon/query pair (after p24grass 26107/26117)
