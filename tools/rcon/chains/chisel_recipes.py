#!/usr/bin/env python3
"""chisel-recipes — the chisel universal-gate live acceptance chain.

Chain semantics (task chisel-recipes ACCEPTANCE ③, the ToolCompat.java:224-229
...
the session model ignores chain.preferred_ports — the aqua-fluids lesson).

Run:  GT6_SESSION=off python3 tools/rcon/chains/chisel_recipes.py
"""
...
# (ids re-keyed by stoneblocks-16item-registry-split: the blockstate variant
