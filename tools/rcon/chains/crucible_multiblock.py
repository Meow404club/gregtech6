#!/usr/bin/env python3
"""crucible-multiblock — the LARGE crucible live acceptance chain (task
crucible-multiblock ACCEPTANCE ③④: "搭 Steel 墙大型坩埚→结构成立→y0 层
...
Run:  python3 tools/rcon/chains/crucible_multiblock.py --node 1.20.1-forge
      python3 tools/rcon/chains/crucible_multiblock.py --node 1.21.1-neoforge
"""
