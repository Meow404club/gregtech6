#!/usr/bin/env python3
"""p29-w5-t3 machine face — the soft-hammer rotation arm (task p29-w5-t3-machine-face-four
ACCEPTANCE ③, the p25_tool_hammer_wrench give-arm shape + the /gt6machineface stand-in
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w5_t3_machine_face_softhammer.py
"""
...
CHAIN = Chain(
    name="p29-w5-t3-machine-face-softhammer",
    slug="p29w5t3softhammer",
