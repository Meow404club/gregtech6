#!/usr/bin/env python3
"""p34-pool-cover-hosts — the real cover-host live acceptance chain.

The live half of task p34-pool-cover-hosts: the two production carriers mount
