#!/usr/bin/env python3
"""p29-w1-electricloom — the ElectricLoom chain (task p29-w1-eu-hu-families, the EU
...
(the p16_pattern_checker precedent). passes=2 is the idempotency proof.

Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w1_electricloom.py
"""
...
CHAIN = Chain(
    name="p29-w1-electricloom",
    slug="p29w1electricloom",
