#!/usr/bin/env python3
"""engine-steam — the Steam Engine KU-source acceptance chain (declarative framework).

Chain semantics (task engine-steam acceptance b) — the P12 fluid-engine chain's first
full loop: steam -> KU -> crusher.
  ...
  B the e2e quad — DIRECT intake-face injection (ADR 2026-09-02-steam-proof-deviation,
...
Run:  python3 tools/rcon/chains/engine-steam.py
"""
