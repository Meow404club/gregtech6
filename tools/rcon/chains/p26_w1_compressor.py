#!/usr/bin/env python3
"""p26-w1-compressor — the Compressor family (KU) live acceptance chain, the FULL
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p26_w1_compressor.py
"""
...
CHAIN = Chain(
    name="p26-w1-compressor",
    slug="p26w1compressor",
