#!/usr/bin/env python3
"""eu-special/autocrafter — the Autocrafter chain (task eu-special
...
of the pre-existing literals (the fe_inbound wiremill_ulv form; inject/check/fluid
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/autocrafter.py
"""
...
# the inventory payload per node (the nbt_rebind key-shape ruling): 4 planks in slot 0
STOCK = {
