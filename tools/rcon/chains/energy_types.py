#!/usr/bin/env python3
"""energy-types — the MU/LU/CU/TU energy-type dial chain (task
energy-types-5tier, the RCON group energy = this one chain).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/energy_types.py
"""
...
steps = [
    ...
    # (the fe_inbound absence-proof form)
