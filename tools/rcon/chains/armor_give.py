#!/usr/bin/env python3
"""armor-give — the Hazmat armor give/census arm (task armor-24;
the hot-lube-lube chest form, RCON sessions have no player so the headless
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/armor_give.py
"""
