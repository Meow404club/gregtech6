#!/usr/bin/env python3
"""implosion — the Implosion Compressor chain (task implosion, the
implosion sweep group; Loader_MultiTileEntities.java:1228).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/implosion.py
"""
...
# (GT6Circuits.applyConfiguration; the act chain form)
