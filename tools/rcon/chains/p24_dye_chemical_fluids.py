#!/usr/bin/env python3
"""p24-dye-chemical-fluids — the dye-chemical family + chlorine live chain (declarative
framework, the p21_drying_food shape).

Chain semantics (task p24-dye-chemical-fluids ACCEPTANCE — "/gt6tank 注 2304mB
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p24_dye_chemical_fluids.py
"""
...
CHAIN = Chain(
    name="p24-dye-chemical-fluids",
    slug="p24dyechemical",
    sites=gt6world.declare_sites(BARREL_SITE),
    preferred_ports=(26106, 26116),      # this card's pinned rcon/query pair (the 2610x segment, after p21dryingfood 26104/26114)
    steps=steps,
)
