#!/usr/bin/env python3
"""p35-portal-end — the Miniature End Portal live chain (task
p35-portals-mini-nether-end, RCON group p35_portals). The ×128/512m pairing
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p35_portal_end.py
"""
...
CHAIN = Chain(
    name="p35-portal-end p35_portals",
    slug="p35portalend",
