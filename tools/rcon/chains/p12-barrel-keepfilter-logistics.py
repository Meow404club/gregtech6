#!/usr/bin/env python3
"""p12-barrel-keepfilter-logistics — the keepFilter acceptance chain.
...
Run:  python3 tools/rcon/chains/p12-barrel-keepfilter-logistics.py
"""
...
CHAIN = Chain(
    name="p12-barrel-keepfilter-logistics",
    slug="p12bkl",
