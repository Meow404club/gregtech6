#!/usr/bin/env python3
"""chisel-drop-conversion — the mining-drop chisel conversion live chain.
...
ports; the session model ignores chain.preferred_ports — the aqua-fluids lesson).

Run:  GT6_SESSION=off python3 tools/rcon/chains/chisel_drops.py
"""
