#!/usr/bin/env python3
"""builder-wand-oneclick — the builder-wand ONE-CLICK live acceptance chain.
...
(ADR 2026-09-12-builder-wand-oneclick). The research
(research.r-builder-wand-second-root) proved the pre-P28 "wand builds half a
...
Run:  python3 tools/rcon/chains/builder_wand_oneclick.py --node 1.20.1-forge
      python3 tools/rcon/chains/builder_wand_oneclick.py --node 1.21.1-neoforge
"""
