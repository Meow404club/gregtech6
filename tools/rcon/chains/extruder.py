#!/usr/bin/env python3
"""press-extruder-molds — the Extruder (HU) ladder live chain (the declarative
framework, the press shape).

Chain semantics (task press-extruder-molds ACCEPTANCE rcon ② — "双腿 extruder 链：
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/extruder.py
"""
...
CHAIN = Chain(
    ...
    preferred_ports=(26112, 26122),      # this card's pinned rcon/query pair (after press 26111/26121)
    steps=steps,
)
