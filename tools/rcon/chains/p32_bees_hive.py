#!/usr/bin/env python3
"""p32_bees_hive — the BumbleHive live acceptance chain (task p32-bees-lv2, the
p31_strata_lens chain shape).
...
Chain semantics (the task-card RCON arms):
  ...
  C the EMBEDDED form live place (chunk 4,4): the stone slab y12..16 + apron makes EVERY
    ...
    live twin — decisions.2026-09-18-p31-strata-lens-determinism-acceptance).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p32_bees_hive.py
"""
