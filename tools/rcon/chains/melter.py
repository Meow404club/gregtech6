#!/usr/bin/env python3
"""melter — the Melter HU single live acceptance chain (task
heat-smelter, the smelter shape over the ONE :1657 row —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/melter.py
"""
