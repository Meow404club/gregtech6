#!/usr/bin/env python3
"""portal-nether — the Miniature Nether Portal live chain (task
portals-mini-nether-end, RCON group portals). The CROSS-DIMENSION triple
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/portal_nether.py
"""
...
CHAIN = Chain(
    # the name carries the group key: sweep --group portals matches
    name="portal-nether portals",
    slug="portalnether",
