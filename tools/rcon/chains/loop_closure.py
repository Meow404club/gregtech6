#!/usr/bin/env python3
"""loop-closure-chain — the canonical water→steam loop, end to end (declarative framework).

Chain semantics (task loop-closure-chain ACCEPTANCE): the P14 canonical chain
...
Run:  python3 tools/rcon/chains/loop_closure.py
"""
...
steps += [
    ...
    # machine-fluid-gui: the gt6:dryer supplier is bound, so the check probe
