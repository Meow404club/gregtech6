#!/usr/bin/env python3
"""large-coagulator — the Large Coagulator Array chain (task large-12,
the large12 sweep group; Loader_MultiTileEntities.java:1231).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/large_coagulator.py
"""
...
CHAIN = Chain(
    name="large-coagulator large12",
    slug="largecoagulator",
