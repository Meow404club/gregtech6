#!/usr/bin/env python3
"""cryo-tower — the Cryo Distillation Tower live acceptance chain (task
distill-crucible ACCEPTANCE ②: Cryo CU 供能互拒臂（W2 守卫活体）).
...
Run:  python3 tools/rcon/chains/cryo_tower.py --node 1.20.1-forge
      python3 tools/rcon/chains/cryo_tower.py --node 1.21.1-neoforge
"""
...
CHAIN = Chain(
    name="distill_crucible cryo_tower",
    slug="cryotower",
