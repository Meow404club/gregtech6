#!/usr/bin/env python3
"""burning-box-family — the burning-box acceptance chain (declarative framework).

Chain semantics (task burning-box-family ACCEPTANCE):
...
Run:  python3 tools/rcon/chains/burning_box_family.py
"""
