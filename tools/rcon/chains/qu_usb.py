#!/usr/bin/env python3
"""usb-data — the USB Stick data-face chain (task usb-data, the qu_usb
...
scanner/replicator card consumes this face), so the chain proves the data plane:
  ...
  A THE REGISTRATION CENSUS (the acceptance-① live half; the armor-give
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/qu_usb.py
"""
