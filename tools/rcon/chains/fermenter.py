#!/usr/bin/env python3
"""fermenter — the Fermenter chain (task eu-hu-families ACCEPTANCE ④:
...
EUt=16 semantics):
  ...
  the HU window arms (the direct inject rig):
    ...
    the block is GONE (the STAT FAILED absence proof, the fe_inbound arm-D form).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/fermenter.py
"""
