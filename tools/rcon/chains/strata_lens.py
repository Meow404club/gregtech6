#!/usr/bin/env python3
"""strata-lens — the strata-lens live acceptance chain (the veins chain shape).
...
tools/rcon/scan_strata_lens.py (the vein_scan form), not this chain.
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/strata_lens.py
"""
