#!/usr/bin/env python3
"""p29-w1-boxinator — the Boxinator chain (task p29-w1-eu-hu-families, the EU
...
The inventory merge carries BOTH row inputs (the p26_w1_press two-slot shape,
the loader-versioned Count/count fork). passes=2 is the idempotency proof.

Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w1_boxinator.py
"""
