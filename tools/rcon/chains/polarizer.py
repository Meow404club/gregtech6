#!/usr/bin/env python3
"""polarizer — the Polarizer family (MU, RM.POLARIZER) live acceptance chain, the
FULL 5-tier ladder T1-T5 (task exotic-energy ACCEPTANCE ①/④: the MU machine eats
MU packets and REFUSES EU/RU packets — the energy-type gate LIVE, the MU arm of the
three-type trio).

Rig split (the energy_types arm-E source-dial precedent — the LIVE gate must go
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/polarizer.py
"""
