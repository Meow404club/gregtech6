#!/usr/bin/env python3
"""p33-food-tail — the card-block-outside drink-fluid live chain (the p33fooddrink shape).
  ...
  A the DRINK arms: one real right-click dispatch per arm (/gt6drink use drives
    ...
    the GTBarrelBlock.use seam via the p33-food-tail tryTankDrink helper):
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p33_food_tail.py
"""
...
# convention (this bbox keeps 418..422 with margin, clear of p33fooddrink's
# 402..406 and the p24act/p26cfoam 408..416 run); nothing sits east of 416 on
# the row
...
CHAIN = Chain(
    ...
    preferred_ports=(26135, 26145),      # this card's pinned rcon/query pair (after p33fooddrink 26113/26123, 26129/26139..26134/26144 taken)
    steps=steps,
)
