#!/usr/bin/env python3
"""stoneblocks-16item-registry-split — the per-pair registry behavior face.
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/stoneblocks_split.py
"""
...
CHAIN = Chain(
    name="stoneblocks-16item-registry-split",
    slug="stonesplit",
