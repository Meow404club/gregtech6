#!/usr/bin/env python3
"""large-electrolyzer — the Large Electrolyzer chain (task large-12, the
large12 sweep group; Loader_MultiTileEntities.java:1230).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/large_electrolyzer.py
"""
...
CHAIN = Chain(
    name="large-electrolyzer large12",
    slug="largeelectrolyzer",
