#!/usr/bin/env python3
"""pressurewasher — the Pressure Washer family (RU, RM.PRESSURE_WASHER) live
acceptance chain, the FULL ladder T1-T4 (task kinetic-process-ladder
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/pressurewasher.py
"""
