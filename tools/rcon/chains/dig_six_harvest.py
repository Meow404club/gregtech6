#!/usr/bin/env python3
"""dig-six HARVEST chain — the spade harvestableSpade drop conversion live arm.

Chain semantics (task dig-six RCON arm 4, the /gt6dig mine channel — the
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/dig_six_harvest.py
"""
