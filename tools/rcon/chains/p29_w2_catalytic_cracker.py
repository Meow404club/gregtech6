...
group p29_w2_hu_tu; re-pinned by p30-rcon-chain-repair onto the TRUE row — the W2 smoke
row (charcoal + water -> coal) was replaced by the p29-w4-f1 chemicals card with the
