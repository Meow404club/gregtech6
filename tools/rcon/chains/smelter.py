#!/usr/bin/env python3
"""smelter — the Smelter HU 4-ladder live acceptance chain (task
heat-smelter, the steam_cracker shape minus the fluid-input leg —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/smelter.py
"""
...
CHAIN = Chain(
    # the name carries the band key: sweep --group heat_smelter matches this
    # member substring and joins the whole cluster (the hu_tu form)
    name="smelter heat_smelter",
    slug="smelter",
