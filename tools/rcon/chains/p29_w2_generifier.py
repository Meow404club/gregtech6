#!/usr/bin/env python3
"""p29-w2-generifier — the TU Generifier chain (task p29-w2-hu-tu-piggyback, group
p29_w2_hu_tu; the TU single :1652 with NBT_PARALLEL 100 over the JSON-poured
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w2_generifier.py
"""
...
CHAIN = Chain(
    name="p29-w2-generifier p29_w2_hu_tu",
    slug="p29w2generifier",
