#!/usr/bin/env python3
"""p31-retriever-cover — the item retriever cover live acceptance chain.

The live half of task p31-retriever-cover. Two arms over the same pipe geometry
...
Run:  python3 tools/rcon/chains/p31_retriever_cover.py
      python3 tools/rcon/chains/p31_retriever_cover.py --node 1.21.1-neoforge
"""
