#!/usr/bin/env python3
"""eu-bridge (engine leg) — the Electric Engine EU->KU live acceptance chain
(task eu-bridge RCON group eu_bridge).
  ...
  A the intake + conversion-accounting legs: the EU dial behind the engine (the
    ...
    rotation-carrier unification ADR 2026-09-02-rotation-carrier; the declared
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/electric_engine.py
"""
...
CHAIN = Chain(
    name="eu_bridge electric engine",
    slug="engine",
