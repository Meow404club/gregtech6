#!/usr/bin/env python3
"""sensors-trivial-14 — the sensor-batch live acceptance chain (the sensors_core shape).

The card's ACCEPTANCE ③ face: "RCON 新组 sensors 双腿[0,0]（代表件 place+check 臂）".
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/sensors_trivial.py
      python3 tools/rcon/chains/sensors_trivial.py --node 1.21.1-neoforge
"""
