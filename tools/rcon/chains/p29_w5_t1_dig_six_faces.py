#!/usr/bin/env python3
"""p29-w5-t1-dig-six FACES chain — the mining-surface live legs (the offline-pure/tag
split: this chain carries the TAG arms the offline JVM cannot bind).

Chain semantics (task p29-w5-t1-dig-six RCON arm 5 — the /gt6dig speed + mine channels,
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w5_t1_dig_six_faces.py
"""
...
CHAIN = Chain(
    name="p29-w5-t1-dig-six-faces",
    slug="p29w5t1digsixfaces",
