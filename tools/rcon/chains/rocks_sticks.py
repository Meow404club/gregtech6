#!/usr/bin/env python3
"""rocks_sticks — the surface rock/stick live acceptance chain (task
rocks-sticks; the P21 stoneblocks destroy-drop form).
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/rocks_sticks.py
"""
