#!/usr/bin/env python3
"""blade-six ROCK chain — the club rockGt crush live arm.

Chain semantics (task blade-six RCON arm 3, the /gt6blade mine channel —
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/blade_six_rock.py
"""
