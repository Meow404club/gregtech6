#!/usr/bin/env python3
"""eu-core slicer — the Slicer family chain (task eu-core-5tier
...
RE-RECORD (task fix-P29-slicer-chain): B/C originally pinned the
slicer.json smoke row (stone+stone -> 2x stone_slab); that fake row was deleted
by slicer-row-domain (the smoke pins went 5 -> 4), leaving outputs=[]
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/slicer.py
"""
