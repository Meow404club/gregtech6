#!/usr/bin/env python3
"""p29-w4-f1-chemicals (gas leg) — the Gas Turbine chain over the TRUE FM.Gas rows
(task p29-w4-f1-chemicals, RCON group p29_w4_chemicals; the p29_w3 natural-gas shape
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p29_w4_chemicals_gas_turbine.py
"""
...
CHAIN = Chain(
    name="p29-w4-chemicals-gas-turbine p29_w4_chemicals",
    slug="p29w4chemicalsgasturbine",
