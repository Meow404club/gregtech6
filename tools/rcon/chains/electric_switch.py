#!/usr/bin/env python3
"""electric-nineteen SWITCH chain — the sneak bare-target twin swap live arm
(task electric-nineteen, the chain-2 column x620..626; the :162/:171
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/electric_switch.py
"""
...
CHAIN = Chain(
    name="electric_tools electric-switch",
    slug="electricswitch",
