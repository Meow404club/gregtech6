#!/usr/bin/env python3
"""p32-logistics-lv2 — the logistics wire live acceptance chain.

The live half of task p32-logistics-lv2. One column over the z=248 band
...
Run:  python3 tools/rcon/chains/p32_logistics_lv2.py
      python3 tools/rcon/chains/p32_logistics_lv2.py --node 1.21.1-neoforge
"""
