#!/usr/bin/env python3
"""heat-exchanger — the Large Heat Exchanger live acceptance chain (task
heat-smelter; the large_boiler boiler-stack form — the HU fixture
IS the boiler):
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/heat_exchanger.py
"""
...
CHAIN = Chain(
    name="heat-exchanger heat_smelter",
    slug="heatexchanger",
