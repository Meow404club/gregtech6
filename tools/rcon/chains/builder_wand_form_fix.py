#!/usr/bin/env python3
"""builder-wand-form-fix — the crucible anchored-walk live acceptance chain.
...
Run:  python3 tools/rcon/chains/builder_wand_form_fix.py --node 1.20.1-forge
      python3 tools/rcon/chains/builder_wand_form_fix.py --node 1.21.1-neoforge
"""
