#!/usr/bin/env python3
"""rollformer — the Roll Former RU ladder live acceptance chain (task
...
driver the P26 W1 trio and the P28 arms C used).
  ...
  B THE T2-T4 INJECT LADDER: one item in, packet = the tier max (256/1024/4096), the
    ...
    heat-smelter, the upstream :314 handler plate 1 -> railGt 4; the shipped row
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/rollformer.py
"""
