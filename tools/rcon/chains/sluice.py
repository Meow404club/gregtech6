#!/usr/bin/env python3
"""sluice — the Sluice family (RU, RM.SLUICE) live acceptance chain, the FULL
ladder T1-T4 (task kinetic-process-ladder ACCEPTANCE ④: 双最低输入行跑通).
...
Rig split (the card RCON ruling):
  ...
  T2-T4 — the gt6machine inject rig (the wiremill form), each tier fed both
    minimum legs.
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/sluice.py
"""
