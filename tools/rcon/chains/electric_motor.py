#!/usr/bin/env python3
"""eu-bridge (motor leg) — the Electric Motor EU->RU live acceptance chain
(task eu-bridge RCON group eu_bridge; the gt6rcon diesel->axle 判例
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/electric_motor.py
"""
