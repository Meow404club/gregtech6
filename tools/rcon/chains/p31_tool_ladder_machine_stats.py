#!/usr/bin/env python3
"""p31-machine-ladder MACHINE STATS chain — the machine-family ladder per-material verdicts.

Chain semantics (task p31-machine-ladder acceptance — the "逐材质 wrench/cutter 等身份
...
p11_cover_shutter_filter form). The report IS the verdict:
...
Run:  GT6_SESSION=off python3 tools/rcon/chains/p31_tool_ladder_machine_stats.py
...
CHAIN = Chain(
    name="p31-tool-ladder-machine-stats",
    slug="p31toolladdermachinestats",
    sites=ANCHOR,
