#!/usr/bin/env python3
"""coagulator — the TU Coagulator chain (task hu-tu-piggyback, group
hu_tu; the TU single :1651 over the JSON-poured coagulator.json FLUID-ONLY smoke
row — water 1000 -> 1 snowball, eUt 1, duration 64):
  ...
  the energy_types chain doc and the GT6EnergyDynamicsTest doc — the machine-side
  ...
  is GONE (the STAT FAILED absence proof, the fermenter arm-B form).

passes=2 is the idempotency proof.
Run:  GT6_SESSION=off python3 tools/rcon/chains/coagulator.py
"""
