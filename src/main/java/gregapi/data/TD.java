/**
 * Ported from GregTech 6 (1.7.10), file gregapi/data/TD.java (upstream 615 lines),
 * by task gt-material-dataset. Every TagData constant group of the upstream file is
 * carried here with the exact upstream key strings and display names, so the TagData
 * registry keys match 1:1 (TagData.createTagData is idempotent by upper-cased name,
 * TagData.java:77-81).
 *
 ...
 * - gregapi.data.LH is NOT ported (MC chat facing). The Energy group tags (upstream :71-221)
 *   pass an LH.Chat color as 4th createTagData argument; that parameter is presentation-only,
 *   so it is stripped here and the plain (key, short name) form is used. Tag identity (the
 *   upper-cased key) is unaffected.
 * - Upstream ArrayListNoNulls<>(F, ...) becomes ArrayList<>(Arrays.asList(...)); the seeded
 *   values are compile-time constants and never null, so the null-drop is a no-op.
 */
public class TD {
	/** For NEI and Creative Mode Menus */ // TD.java:36-40
	...
	/** For the Projectile System. */ // TD.java:42-48
	...
	/** For Pipe Networks. Mainly connectivity. */ // TD.java:50-62
	public static class Connectors {
		...
		public static final List<TagData> ALL_ITEM_TRANSPORT                = new ArrayList<>(Arrays.asList(PNEUMATIC_ITEM));
	}

	/** For Energy Systems. You can create your own kind of Energy too of course, but I have added some Defaults in order to make things simpler. */ // TD.java:64-222
	public static class Energy {
		 ...
		 * Amount = Amperage
		 */
		public static final TagData ELECTRICITY                             = TagData.createTagData("ENERGY.ELECTRICITY", "EU"), EU = ELECTRICITY;
		 ...
		 * Amount = Power
		 */
		public static final TagData KINETIC_ROTATION                        = TagData.createTagData("ENERGY.KINETIC_ROTATION", "RU"), RU = KINETIC_ROTATION;
		 ...
		 * Amount = Power
		 */
		public static final TagData KINETIC_PUSH                            = TagData.createTagData("ENERGY.KINETIC_PUSH", "KU"), KU = KINETIC_PUSH;
		 ...
		 * Amount = Temperature
		 */
		public static final TagData HEAT                                    = TagData.createTagData("ENERGY.HEAT", "HU"), HU = HEAT;
		 ...
		 * Amount = Temperature
		 */
		public static final TagData CRYO                                    = TagData.createTagData("ENERGY.CRYO", "CU"), CU = CRYO;
		 ...
		 */
		public static final TagData LIGHT                                   = TagData.createTagData("ENERGY.LIGHT", "LU"), LU = LIGHT;
		 ...
		 */
		public static final TagData MAGNETIC                                = TagData.createTagData("ENERGY.MAGNETIC", "MU"), MU = MAGNETIC;
		 ...
		 * Amount = Temperature
		 */
		public static final TagData NEUTRON                                 = TagData.createTagData("ENERGY.NEUTRON", "NU"), NU = NEUTRON;
		 ...
		 * Amount = Nobody knows
		 */
		public static final TagData QUANTUM                                 = TagData.createTagData("ENERGY.QUANTUM", "QU"), QU = QUANTUM;

		/**
		 * Energy Tag for Time. Machines which simply run on time use this token.
		 * Size = unused (always 1)
		 * Amount = Ticks
		 */
		public static final TagData TIME                                    = TagData.createTagData("ENERGY.TIME", "TU"), TU = TIME, TICK = TIME;
		 ...
		 * Amount = RF
		 */
		public static final TagData REDSTONE_FLUX                           = TagData.createTagData("ENERGY.REDSTONE_FLUX", "RF"), RF = REDSTONE_FLUX;
		 ...
		 * Amount = MJ
		 */
		public static final TagData MINECRAFT_JOULES                        = TagData.createTagData("ENERGY.MINECRAFT_JOULES", "MJ"), MJ = MINECRAFT_JOULES;
		 ...
		 */
		public static final TagData STEAM                                   = TagData.createTagData("ENERGY.STEAM", "Steam");
		 ...
		 */
		public static final TagData AIR                                     = TagData.createTagData("ENERGY.AIR", "AU"), AU = AIR;

		/** Energy Tag for Ordo Vis. In MilliVis Units. 10 = 1 CentiVis. 1000 = 1 Full Vis. */
		public static final TagData VIS_ORDO                                = TagData.createTagData("ENERGY.VIS_ORDO", "Ordo");
		/** Energy Tag for Aer Vis. In MilliVis Units. 10 = 1 CentiVis. 1000 = 1 Full Vis. */
		public static final TagData VIS_AER                                 = TagData.createTagData("ENERGY.VIS_AER", "Aer");
		/** Energy Tag for Aqua Vis. In MilliVis Units. 10 = 1 CentiVis. 1000 = 1 Full Vis. */
		public static final TagData VIS_AQUA                                = TagData.createTagData("ENERGY.VIS_AQUA", "Aqua");
		/** Energy Tag for Terra Vis. In MilliVis Units. 10 = 1 CentiVis. 1000 = 1 Full Vis. */
		public static final TagData VIS_TERRA                               = TagData.createTagData("ENERGY.VIS_TERRA", "Terra");
		/** Energy Tag for Ignis Vis. In MilliVis Units. 10 = 1 CentiVis. 1000 = 1 Full Vis. */
		public static final TagData VIS_IGNIS                               = TagData.createTagData("ENERGY.VIS_IGNIS", "Ignis");
		/** Energy Tag for Perditio Vis. In MilliVis Units. 10 = 1 CentiVis. 1000 = 1 Full Vis. */
		public static final TagData VIS_PERDITIO                            = TagData.createTagData("ENERGY.VIS_PERDITIO", "Perditio");
		/** Set of Energy Tags which are of the Vis Type. In MilliVis Units. The Acronym "VIS" stands for "Very Interesting Stuff" */
		public static final List<TagData> VIS                               = new ArrayList<>(Arrays.asList(VIS_ORDO, VIS_AER, VIS_AQUA, VIS_TERRA, VIS_IGNIS, VIS_PERDITIO));

		/** Contains all known Energy Tags. */
		public static final List<TagData> ALL                               = new ArrayList<>(Arrays.asList(VIS_ORDO, VIS_AER, VIS_AQUA, VIS_TERRA, VIS_IGNIS, VIS_PERDITIO, STEAM, MJ, RF, AU, QU, MU, LU, HU, CU, KU, RU, EU, NU, TU));
		/** Contains all known Energy Tags, which can be converted to or from RF. */
		public static final List<TagData> ALL_RF                            = new ArrayList<>(Arrays.asList(MJ, RF, KU));
		/** Contains all known Energy Tags, which are worth exactly 1 EU. */
		public static final List<TagData> ALL_EU                            = new ArrayList<>(Arrays.asList(AU, QU, MU, LU, KU, RU, EU, HU, NU, CU));
		/** Contains all known Energy Tags, which are actually used by GT6. */
		public static final List<TagData> ALL_GT                            = new ArrayList<>(Arrays.asList(AU, QU, MU, LU, KU, RU, EU, HU, NU, CU, TU));
		/** Contains all known Energy Tags, which are kinetic. */
		public static final List<TagData> ALL_KINETIC                       = new ArrayList<>(Arrays.asList(KU, RU));
		/** Contains all known Energy Tags, which are electric. */
		public static final List<TagData> ALL_ELECTRIC                      = new ArrayList<>(Arrays.asList(EU));
		/** Contains all known Energy Tags, which are electric. */
		public static final List<TagData> ALL_NEGATIVE_ALLOWED              = new ArrayList<>(Arrays.asList(AU, QU, MU, KU, RU, EU));
		/** Contains all known Energy Tags, which are weak to Water, such as electricity. */
		public static final List<TagData> ALL_WEAK_TO_WATER                 = new ArrayList<>(Arrays.asList(EU, HU, CU));
		/** Contains all known Energy Tags, which are weak to Thunder, such as electricity. */
		public static final List<TagData> ALL_WEAK_TO_THUNDER               = new ArrayList<>(Arrays.asList(EU));
		/** Contains all known Energy Tags, which are weak to Fire, such as electricity. */
		public static final List<TagData> ALL_WEAK_TO_FIRE                  = new ArrayList<>(Arrays.asList(EU, CU));
		/** Contains all known Energy Tags, which are Temperature based. */
		public static final List<TagData> ALL_HOT_COLD                      = new ArrayList<>(Arrays.asList(HU, CU, VIS_IGNIS));
		/** Contains all known Energy Tags, which have a limited consumption of Packets. */
		public static final List<TagData> ALL_COMSUMPTION_LIMITED           = new ArrayList<>(Arrays.asList(EU, RF, VIS_ORDO, VIS_AER, VIS_AQUA, VIS_TERRA, VIS_IGNIS, VIS_PERDITIO));
		/** Contains all known Energy Tags, which use cause Explosions when the Machines are overloaded. */
		public static final List<TagData> ALL_EXPLODING                     = new ArrayList<>(Arrays.asList(AU, QU, MU, LU, KU, RU, EU, HU, NU, MJ, STEAM));
		...
		public static final List<TagData> ALL_ALTERNATING                   = new ArrayList<>(Arrays.asList(KU));
		...
		public static final List<TagData> ALL_SIZE_IRRELEVANT               = new ArrayList<>(Arrays.asList(VIS_ORDO, VIS_AER, VIS_AQUA, VIS_TERRA, VIS_IGNIS, VIS_PERDITIO, STEAM, MJ, RF, HU, CU, NU, QU, TU));
	}

	/** For Prefixes */ // TD.java:224-300
	...
	/** For Atomic Materials */ // TD.java:302-381
	public static class Atomic {
		...
		public static final List<TagData> ALL                               = new ArrayList<>(Arrays.asList(ELEMENT, PARTICLE, MOLECULE, ANTIMATTER, METAL, ALKALI_METAL, ALKALINE_EARTH_METAL, LANTHANIDE, ACTINIDE, TRANSITION_METAL, POST_TRANSITION_METAL, METALLOID, NONMETAL, POLYATOMIC_NONMETAL, DIATOMIC_NONMETAL, NOBLE_GAS));
	}

	/** General Material Properties */ // TD.java:383-476
	...
	/** For Material Processing */ // TD.java:496-545
	public static class Processing {
		...
		public static final List<TagData> ALL_MACHINES                      = new ArrayList<>(Arrays.asList(CRYSTALLISABLE, CRUCIBLE_ALLOY, FURNACE, NEVER_FURNACE, SMITHABLE, MELTING, MORTAR, COOL2CRYSTAL, FUSION, UUM, ELECTROLYSER, CENTRIFUGE, UNRECYCLABLE, SOLDERING_MATERIAL));
		public static final List<TagData> ALL_ORES                          = new ArrayList<>(Arrays.asList(CRYSTALLISABLE, WASHING_FIRESTONE, WASHING_PERSULFATE, WASHING_MERCURY, PULVERIZING_CINNABAR));
	}

	/** For Materials and the Item Generator */ // TD.java:547-614
