/**
 * Ported from GregTech 6 (1.7.10), file gregapi/code/ITagDataContainer.java (upstream 89 lines).
 *
 ...
 *
 * Pure Java, ported verbatim. C is the Class which implements this Interface.
 */
