/**
 * Ported from GregTech 6 (1.7.10), file gregapi/code/HashSetNoNulls.java (upstream 96 lines).
 *
 ...
 *
 * Pure Java, ported verbatim. Null elements are silently ignored on add.
 */
