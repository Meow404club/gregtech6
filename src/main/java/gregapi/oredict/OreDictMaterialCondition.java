/**
 * Ported from GregTech 6 (1.7.10), file gregapi/oredict/OreDictMaterialCondition.java (upstream 126 lines),
 * by task p2-material-condition-system. Verbatim port; no Minecraft coupling upstream either.
 *
