// P15 骨架 W1 POC 段（work/p15-stonecutter-skeleton，不合 main）：
// root settings 石匠容器化——ADR-P2-1 的「root gregtech6 + include 'mdk'」演进为
...
// 0.9.8 强制 Gradle 9 而 MDG 无 Gradle 9 声明，升版=独立卡。
