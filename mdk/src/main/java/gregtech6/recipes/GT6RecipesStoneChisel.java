...
public final class GT6RecipesStoneChisel {
	...
	public static final List<String> SKIPPED_UPSTREAM = List.of(
			...
			"GT_Tool_Chisel.java:57-79 convertBlockDrops (the mining-drop chisel conversion, vanilla stone/stonebrick/BlockStones) — 1.20.1 has no HarvestDropsEvent (architect ruling: pooled)",
