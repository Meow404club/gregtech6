...
/**
 * The Generic Logistics Import Bus — 1.20.1 port of gregapi/cover/covers/
 * CoverLogisticsGenericImport.java (:31-41, upstream item id 1096), task
 * p33-logistics-covers-12. The unfiltered bus: the covered-face adjacency exports BOTH
 * items and fluids (:417-424 of the Core — the fluid arm skips when the adjacency is a
